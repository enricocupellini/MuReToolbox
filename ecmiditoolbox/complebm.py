...
# % See License.txt
    ...
    if method.lower() == 'p':
        ...
        aveint_ = np.mean(np.diff(pitches)) * .3;
    ...
    # Creazione di una distribuzione di probabilità di esempio
    prob_distribution = np.array([0.4, 0.3, 0.2, 0.1])

    # Calcolo dell'entropia
    entropia_valore = entropy(prob_distribution, base=2)
