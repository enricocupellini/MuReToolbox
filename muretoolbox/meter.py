...
from ofacorr import ofacorr

import numpy as np

def meter(nmat,option):
    """
...
% See License.txt
    ...
    if option is None:
        ...
        if option.lower() != 'optimal':
            print("Unknown option:", option)
            print("Accepted option is 'optimal'!")
            return None
        
        return weighted_meter(nmat)

def weighted_meter(nmat):
